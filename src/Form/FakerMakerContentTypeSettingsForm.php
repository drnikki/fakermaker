...
class FakerMakerContentTypeSettingsForm extends ConfigFormBase {

  /**
   * {@inheritdoc}
   */
  public function getFormID() {
    return 'fakermaker_content_type_settings_form';
  }
  ...
  protected function getEditableConfigNames() {
    // this should be one per content type.
    return ['fakermaker.content.settings'];
  }
  ...
  public function buildForm(array $form, FormStateInterface $form_state, $entity_type = NULL) {
    ...
    $config = $this->config('fakermaker.content.settings');
